...
export default function AuthCallbackPage() {
  ...
  return (
    <div style={{ minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", background: "#111224", color: "white" }}>
      <div className="glass" style={{ padding: "3rem", borderRadius: "1.5rem", textAlign: "center", border: "1px solid rgba(255,255,255,0.1)" }}>
        <div className="icon-pulse" style={{ marginBottom: "1.5rem", fontSize: "2rem" }}>✨</div>
